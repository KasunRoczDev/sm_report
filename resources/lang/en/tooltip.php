...
return [
    ...
    */
    ...
    'payment_fee' => "Add Your Payment Fee",
    ...
    'invoice_layout' => "Invoice Layout to be used for this business location<br><small class='text-muted'>(<i>You can add new <b>Invoice Layout</b> in <b>Layout Settings<b></i>)</small>",

    'suspend_invoice_layout' => "Suspend Invoice Layout to be used for this business location<br><small class='text-muted'>(<i>You can add new <b>Suspend Invoice Layout</b> in <b>Layout Settings<b></i>)</small>",

    'waybill_layout' => "Waybill Layout to be used for this business location<br><small class='text-muted'>(<i>You can add new <b>Waybill Layout</b> in <b>Layout Settings<b></i>)</small>",

    'paymentreceipt_layout' => "Payment Receipt Layout to be used for this business location<br><small class='text-muted'>(<i>You can add new <b>Payment Receipt Layout</b> in <b>Layout Settings<b></i>)</small>",

    'mark_as_market_price' => "If you <b>Enable</b> this option, this price will define as the <b>Market Price</b> and you can apply this Price as the Market price of your <b>Invoice (Slim 4 )</b>",
    ...
    'total_amount_recovered' => 'Amount recovered from insurance or selling of scraps or odd($sms_settings[\'url\'] . \'?\' . http_build_query($request_data));thers',
    ...
    'max_sale_quantity'=>'Maximum sales quantity per invoice, only available when max sale quantity set',
    'commission_agent_tooltip'=>'A commission Agent is a responsible person who is specific to the product or service. Ex: Salesman',
    'product_table_columns_customize'=>'Drag & Drop for reorder <br> the columns in products table.',
    'dialog_key_tooltip'=>'URL Message Key in Dialog Admin Panel',
    'dialog_mask_tooltip'=>'Source address or the mask which is visible to customer. Optional (If not defined, default mask of the user will be used)',
    'default_purchase_price'=> 'The DEFAULT PURCHASE PRICE means the last added/edited PURCHASE PRICE AFTER DISCOUNT.',

    'lot_scheme_name' => 'Give a short meaningful name to the Lot Scheme.',
    'lot_scheme_prefix' => 'Prefix for an Lot Scheme.<br>A Prefix can be a custom text or current year. Ex: #XXXX0001, #2018-0002',
    'lot_scheme_start_number' => "Start number for lot numbering. <br><small class='text-muted'>You can make it 1 or any other number from which numbering will start.</small>",
    'lot_scheme_count' => 'Total number of lot generated for the Lot Scheme',
    'lot_scheme_total_digits' => 'Length of the Lot Number excluding Lot Prefix',
     'bat_shape_label' => 'Bat Shape Label: Our unique and artistic labels shaped like bats add an exclusive touch to your jewelry purchase, making it truly special',
    'if_bat_shape_label_is_enable' => ' If `Jewelry label design` is active, it takes precedence over other settings, like the barcode order. Please consider this when using the feature'
