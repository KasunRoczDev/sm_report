...
return [
    ...
    'commission_agent_added_success' => 'Agent added successfully',
    'edit_sales_commission_agent' => 'Edit sales commission agent',
    'commission_agent_updated_success' => 'Agent updated successfully',
    'commission_agent_deleted_success' => 'Agent deleted successfully',
    ...
    'all_fixed_sales_commissions' => 'Fixed Sale Commission',
    ...
    'commision_type' => 'Fixed Commission Types',
    'shipping_charges' => 'Shipping Charges',
    'payment_fee' => 'Payment Fee',
    'total_return_payment_fee' => 'Total Return Payment Fee',
    ...
    'export_physical_product_stock_sheet' => 'Export Stock Count Sheet',
    'import_physical_product_stock_sheet' => 'import physical product stock sheet',
    'import_export_physical-product-stock' => 'Import / Export Stock Count Details',
    'Stock_Count_Report' => 'Stock Count Report',
    'stock_count_import_istruction1' => 'Export stock count report.',
    'stock_count_import_istruction2' => 'Update the exported file and import the same file.',
    'stock_count_import_istruction3' => 'Only change the Physical Stock column. If you change the Current Stock column it will not update.',
    ...
    'enable_payment_fee' => 'Enable payment fee',
    'disable_snow' => 'Disable snow',
    ...
    'none' => 'None',
    'enable_imei_or_sr_no' => 'Enable Product description',
    ...
    'search_lotnumber_placeholder' => 'Enter Lot Number',
    'fixed' => 'Fixed',
    ...
    'partial' => 'Partial',
    'setoff' => 'Setoff',
    'partial-setoff' => 'Partial-Setoff',
    'no_of_products' => 'Number of products',
    'select_a_date_range' => 'Select a date range',
    'search_lot_number' => 'Search Lot number',
    'shortcut_help' => "Shortcut should be the names of the keys separated by '+'",
    'shortcut_help_barcode' => "Numbers from 0 to 9 you can use English letters or any other symbol.",
    'example' => 'Example',
    ...
    'customer_signature_label' => 'Customer Signature Label',
    ...
    'variation_values_ins2' => "Values for the variation separated with '|' <br>
                            (Ex: Red|Blue|Green)",
    'variation_values_ins2_imp2' => 'Values for the variation',
    ...
    'sell_return_all' => 'Sell Return All',
    'cancel' => 'Cancel',
    ...
    'bulk_payment_report' => 'Bulk Payment Report',
    ...
    'staff_notification_templates' => 'Staff Notification',
    'new_sale' => 'New Sale',
    ...
    'total_sell_return_round' => 'Total Sell Return Round Off',
    'total_shiping_return' => 'Total Shipping Return',
    ...
    'selected_paymentaccounts' => 'Select Payment Accounts',
    'view_role' => 'View role',
    ...
    'waybill_summary' => 'Waybill Summary',
    'waybill_detailed' => 'Waybill Detailed',
    ...
    'allow_selected_paymentaccounts' => 'Allow Selected Payment Accounts',
    'allow_selected_fundtransferacccounts' => 'Allow Fund Transfer Accounts',
    'allow_selected_contacts_tooltip' => 'Only allow access to selected contacts in sells/purchase customer/supplier search box',
    'allow_selected_paymentaccounts_tooltip' => 'Only allow access to the selected payment account of the Payment account section',
    'allow_selected_fundtransferaccounts_tooltip' => 'Only allow access to the selected payment account for bank transfers',
    ...
    'product_not_found_exception_physical_stock' => 'row :row',
    ...
    'show_payment_fee_help' => 'If the payment fee is enabled it will be displayed on the POS screen',
    'show_order_tax_help' => 'If the order tax is enabled it will be displayed on the POS screen',
    ...
    'round_to_nearest_whole_number' => 'Round to nearest whole number (multiple of :multiple)',
    ...
    whole number:1</b> 2.23 => 2, 2.50 => 3, 2.73 => 3 <br><b>Round to nearest 
    whole number:5</b> 52 => 50, 53 => 55, 57 => 55, 58 => 60<br><b>Round to nearest 
    whole number:10</b> 54 => 50, 55 => 60<br><b>Round to nearest 
    whole number:50</b> 424 => 400, 425 => 450, 467 => 450, 475 => 500 <br><b>Round to nearest 
    ...
    'lot_number_label' => 'Lot Number label',
    ...
    'total_sell_return_shipping_cost' => 'Total Sell Return Shipping Cost',
    ...
    'waybill_layout' => 'Waybill Layout',
    'payment_receipt_layout' => 'Payment Receipt layout',
    ...
    'payment_fee_rate_exempt_help' => 'Zero percent payment fee rate will be considered as payment fee rate exempt',
    ...
    'bartender_help' => 'Bartender Report',
    ...
    'recomended_for_slim4' => 'Market price Vs Local price layout , Recommended 80mm paper Size',
    'classic' => 'Classic',
    'elegant' => 'Elegant',
    'slim' => 'Slim',
    'Standard_01' => 'Standard 01',
    'Standard_02' => 'Standard 02',
    'slim4' => 'Slim 4',
    'detailed' => 'Detailed',
    ...
    'tooltip_sell_product_KOT_column' => 'Tik here if this product needed to print in kitchen',
    'direct_sales' => 'Direct Sales',
    'cod' => 'COD',
    'cod_help' => 'Cash on Delivery',
    'cod_details' => 'COD details',
    'cod_company' => 'Courier Company',
    'cod_district' => 'District',
    'cod_city' => 'City',
    'cod_remark' => 'Special Remark',
    //'show_leads_from' =>'Show Leads',
    'show_leads_from_help' => 'Tik here if you want to print where this order came from',
    'default_sale_type' => 'Select Sale Type',
    'sale_type_already_exists' => 'Sale type is already exists',
    'sale_type_delete_fail' => 'This sale type alredy used in some transactions',
    'stock_transfer_quantity' => 'Total Transfer Out',
    'stock_transfer_quantity_in' => 'Total Transfer In',
    'sold_from_other_locations' => 'Total Sold(From Other Locations)',
    'lot_number_ins' => 'You should enable lot number feature first',
    'cash_drawer' => 'Open Cash Drawer',
    'show_product_description' => 'Show product description',
    'contact_image' => 'Contact Image',
    'show_customer_image' => 'Show Customer Image',
    'created_at' => 'Created At',
    'modified_at' => 'Modified At',
    'cancelled' => 'Cancelled',
    'refund-required' => 'Refund-Required',
    'stock_movement_report' => 'Stock Movement Report',
    'sell_date_range' => 'View all date range',
    'dupplicate_invoice_no_found' => 'Dupplicate Invoice No Found',
    'sku_required' => 'Main product SKU is required if product type is variable',
    'sku_ins_imp2' => "If blank an SKU will be automatically generated Only for single products.
    For variable product Must add the Main Product's SKU then variable SKU will auto generated like below,
    Main product SKU 200<br/> Variable SKU<br/>200-1<br/>200-2<br/>200-3",
    'name_ins_2' => 'Values for the variations products and Values of Several Lot of Opening Stock Must separate from nearest next row',
    'purchase_price_inc_tax_ins2_imp2' => 'Purchase Price (Including Tax) (Only in numbers)<br/>When entering the purchase price for the Variation products, add the purchase price in the row corresponding to the variation value.',
    'purchase_price_exc_tax_ins2_imp2' => 'Purchase Price (Excluding Tax) (Only in numbers)<br/>When entering the purchase price for the Variation products, add the purchase price in the row corresponding to the variation value.',
    'selling_price_ins1_imp2' => 'When entering the Selling price for the Variation products, add the Selling price in the row corresponding to the variation value',
    'opening_stock_help_text_imp2' => 'When entering Variation Products or Several lots opening stock, add the Opening stock in the row corresponding to the variation value or Corresponding to the lot number.',
    'expiry_date_ins_imp2' => 'Stock Expiry Date <br><b>Format: mm/dd/yyyy; Ex: 11/25/2018</b>',
    'expiry_date_ins_imp2_2' => "Column data format must be 'text'",
    'lot_number_ins_imp2' => "You should enable lot number feature first. if have no any lot number, you must Enter '0'",
    'first_name' => 'Firstname',
    'middle_name' => 'Middlename',
    'last_name' => 'Lastname',
    'cmmsn_type' => 'Commission Type',
    'cmmsn_variation' => 'Commission Variation',
    'assign_user' => 'Assign Users',
    'condition_low_level' => 'Minimum Invoice count ',
    'condition_high_level' => 'Maximum invoice count',
    'sale_type' => 'Sale Type',
    'fixed_rate' => 'Fixed Rate',
    'commission' => 'Fixed Commission',
    'view_commission' => 'View Commission Types',
    'add_commission' => 'Add Commission Types',
    'edit_commission' => 'Edit Commission Types',
    'delete_commission' => 'Delete commission types',
    'assign_commission' => 'Assign/Remove user from commission types',
    'all_sales_commissions' => 'All Fixed Sale Commission',
    'remove_success' => 'User remove successfully',
    'sell_daterange' => 'if you disable this permission,you can see today transaction only',
    'enable_header_expence' => 'Enable expenses',
    'enable_due_sales' => 'Enable Due Sales',
    'bulk_settlement' => 'Bulk Settlement',
    'enable_reminder' => 'Enable Reminder',
    'reminder' => 'Reminder',
    'reminders' => 'Reminders',
    'reminder_no' => 'Reminder No.',
    'reminder_interval' => 'Reminder Interval',
    'upcoming_reminder' => 'Upcoming reminder',
    'last_reminded' => 'Last reminded date',
    'stop_reminder' => 'Stop Reminder',
    'subscribe_reminder' => 'Invoice Reminder',
    'reminder_interval' => 'Invoice Reminder Intervals',
    'recur_reminder_repetition_help' => 'If blank invoice will be reminde infinite times',
    'recurring_reminder_invoice_help' => 'If reminder this invoice will be automatically notify at regular intervals.<br>You can disable this feature in <code>Settings > Business Settings > Modules</code>',
    'reminder_invoice_message' => 'New Invoice Reminder for Reminder no.:<i>:subscription_no</i>, Invoice no.: <i>:invoice_no</i>',
    'reminded_invoice' => 'Reminded Invoice',
    'recur_reminder_interval_help' => 'If blank invoice will not be reminde',
    'instruction_line3' => 'When you add both variable products and individual products,You should sort variable products first in the sheet.',
    'duplicate_draft_created_successfully' => 'Duplicate draft created successfully',
    'multi_sale_types' => 'Multi Sale Types',
    'tooltip_sale_types' => 'Fixed commission calculation for use this sale type module',
    'table_column' => 'Table Columns',
    'all_sale_table_column' => 'All Sale table',
    'product_table_column' => 'Products table',
    'product_product_locations' => 'Business Location',
    'product_brands' => 'Product Brands',
    'product_tax_rates' => 'Product Tax rate',
    'product_product_custom_field1' => 'Product custom field1',
    'product_product_custom_field2' => 'Product custom field2',
    'product_product_custom_field3' => 'Product custom field3',
    'product_product_custom_field4' => 'Product custom field4',
    'customer_table' => 'Customer',
    'cus_contact_id' => 'Contact id',
    'cus_business_name' => 'Business name',
    'cus_email' => 'Email',
    'cus_tax_number' => 'Tax no.',
    'cus_credit_limit' => 'Credit limit',
    'cus_pay_term' => 'Pay term',
    'cus_opening_balance' => 'Openning balance',
    'cus_balance' => 'Balance',
    'cus_created_at' => 'Created at',
    'cus_address' => 'Address',
    'cus_mobile' => 'Mobile no.',
    'cus_return_due' => 'Return due',
    'cus_custom_field1' => 'Custom field 1',
    'cus_custom_field2' => 'Custom field 2',
    'cus_custom_field3' => 'Custom field 3',
    'cus_custom_field4' => 'Custom field 4',
    'cus_custom_field5' => 'Custom field 5',
    'cus_custom_field6' => 'Custom field 6',
    'cus_custom_field7' => 'Custom field 7',
    'cus_custom_field8' => 'Custom field 8',
    'cus_custom_field9' => 'Custom field 9',
    'cus_custom_field10' => 'Custom field 10',
    'suppliers_table' => 'Suppliers',
    'sup_contact_id' => 'Contact id',
    'sup_business_name' => 'Business name',
    'sup_email' => 'Email',
    'sup_tax_number' => 'Tax no.',
    'sup_credit_limit' => 'Credit limit',
    'sup_pay_term' => 'Pay term',
    'sup_opening_balance' => 'Openning balance',
    'sup_balance' => 'Balance',
    'sup_created_at' => 'Created at',
    'sup_address' => 'Address',
    'sup_mobile' => 'Mobile no.',
    'sup_return_due' => 'Return due',
    'sup_custom_field1' => 'Custom field 1',
    'sup_custom_field2' => 'Custom field 2',
    'sup_custom_field3' => 'Custom field 3',
    'sup_custom_field4' => 'Custom field 4',
    'sup_custom_field5' => 'Custom field 5',
    'sup_custom_field6' => 'Custom field 6',
    'sup_custom_field7' => 'Custom field 7',
    'sup_custom_field8' => 'Custom field 8',
    'sup_custom_field9' => 'Custom field 9',
    'sup_custom_field10' => 'Custom field 10',
    'enable_pr_pru_price_table' => 'View purchase price',
    'enable_pr_pru_price_table_tooltip' => 'you can view product purchase price on the POS Screen',
    'profit' => 'Profit',
    'purchasing_details' => 'Purchasing Details',
    'enable_pr_sale_price_qty_box' => 'View sale price/avl. qty',
    'enable_pr_sale_price_qty_box_help' => 'you can view product sale price & available qty on the POS Screen',
    'enable_required_lot_no' => 'Lot Number required*',
    'shipping_details' => 'Shipping Details',
    'pay_term_period' => 'Pay term period',
    'pay_term' => 'Pay term',
    'supplier_phone_number' => 'Supplier Phone Number',
    'supplier_email' => 'Supplier Email',
    'profit_margin_cannot_be_empty_in_row' => 'Profit Margin is required in row :row',
    'unit_cost_cannot_be_empty_in_row' => 'Unit Cost is required in row :row',
    'unit_cost' => 'Unit Cost',
    'import_purchase' => 'Import Purchase',
    'preview_imported_purchase' => 'Preview Imported Purchase',
    'either_sup_email_or_phone_required' => 'Either supplier email id or phone number required',
    'contact_img' => 'Contact image',
    'list_pos_table_column' => 'List Pos',

    'totalsavings_label' => 'Total Savings',
    'slim4' => 'SLIM 4',
    'types_of_service_custom_field1' =>'Custom Column 1',
    'types_of_service_custom_field2' =>'Custom Column 2',
    'types_of_service_custom_field3' =>'Custom Column 3',
    'types_of_service_custom_field4' =>'Custom Column 4',

    //barcode setting
    'barcode_setting' => 'Barcode Setting',
    'enable_barcode_secret' => 'Enable Barcode Secret',


    'purchase_imported_successfully' => 'Purchases imported successfully',
    'purchase_choose_location_and_group_by' => 'Choose business location and column by which purchase lines will be grouped',
    //barcode setting
    'barcode_setting' => 'Barcode Setting',
    'enable_barcode_secret' => 'Enable Barcode Secret',
    'allow_login' => 'Allow Login',
    'allow_login_selected_contacts_tooltip' => 'Allowed contacts can login to there leger',
    'add_contact_login_user' => 'Contacts logins create',
    'contact_login_and_permission' => 'Login & Permission',
    'add_contact_login' => 'Add Contact Logins',
    'contact_user' => 'Contacts User',
    'view_contact_user' => 'View contact user',
    'contact_users' => 'Contacts users',
    'customer_login' => 'Customer Logins',
    'contact_type' => 'Contact Type',
    'edit_contact_user' => 'Edit contact users',
    'import_purchase_date' => 'Purchase date time format should be :mm-dd-yyyy; Ex: 11-25-2018',
    'support' => 'Support',
    'totalsavings_label' => 'Total Savings',

    'manufacturing' => 'Manufacturing',
    'enable_line_discount_show' => 'Enable Line Discount Preview',
    'applied_discount_text_pos_row' => 'Discount: <i>:discount_name</i> applied',
    'slim5' => 'SLIM 5',
    'recomended_for_slim5' => 'Details discount layout | Recommended for Terminal printer',
    'price' => 'Price',
    'logo' => 'Current Logo Preview',
    'location_logo' => 'Business Location Logo',
    'close_register_without_view' => 'Close register without a view',
    'purchasing_details_pos' => 'this shows only latest purchase price. Not show lot-number wise purchase price',
    ...
    'disable_auto_complete_search' => 'Disable auto complete search',
    'hide_variation_name' => 'Hide variation name',
    'location_change' => 'Location Change',
    'current_location' => 'Current Location',
    'location_to_modal' => 'Location To',
    'location_change_permission' => 'Enable - Location change on draft and quotation.',
    'location_change_tool' => 'Authorized user can change location of Draft and Quotation invoices',
    'transfer_by' => 'Transferred By',
    'transfer_date' => 'Transferred Date/Time',
    'business_location_from' => 'Business Location (From)',
    'business_location_to' => 'Business Location (To)',
    'location_change_darft_quoation' => 'Location changed Draft/Quotation',
    'list_location_change_darft_quoation' => 'List Location changed Draft/Quotation',
    'due_sale' => 'Due Sale',
    'row_remove' => 'row remove from first',
    'total_value' => 'Total Value',
    'returned' => 'Returned',
    'inprogress' => 'In Progress',
    'return_received' => 'Return Received',
    'product_sell_trend_report' => 'Product Sell Trending Report',
    'show_selling_price_group_in_row_edit_purchase_price' => 'Show selling price groups',
    'exchange_balance' => 'Exchange Balance',
    'exchange' => 'Exchange',
    'required_exchange_balance_not_available' => 'Required exchange balance not available',
    'applicable_in_pch_group' => 'Apply in promo code holders',
    'view_stock_report_pos' => 'View all location stock on The POS',
    'view_pos_stock_report' => 'View stock report',
    'view_pos_stock_report_tooltip' => 'If enable this, the User can view all location stock on the POS. Note: Only permitted users will appear this',
    'tooltip_enable_lot_as_imei' => 'if you enable IMEI, the Lot number will consider as IMEI/ Serial Number. So You can Add IMEI or serial numbers by item quantity.
( For the moment maximum quantity is 200)',
    'draft' => 'Template',
    'edit_purchase_price' => 'Add/Edit Purchasing Price',
    'edit_purchase_sale_price' => 'Add/Edit Selling Price',
    'premium_pakages' => 'Premium Packages',
    'sales_commission_agent_label' => 'Sales Commission Agent Label',
    'show_sales_commission_agent' => 'Show Commission Agent',
    'default_selling_price_is_minimum' => 'The default selling price is the minimum selling price',
    'precentage_from_cost' => 'Percentage from cost (Lowest Profit margin for Alert)',
    'custom_minimum_value' => 'Custom minimum value',
    'enable_option_for_minimum_selling_price' => 'Enable Minimum Selling price option ',
    'suspend_N_request' => 'Suspend & Request',
    'admin_overide_request_not_approved' => 'Admin override request not approved',
    'minimu_price_override' => 'Minimum price approval',
    'aleart' => 'Alert',
    'approval' => 'Approval',
    'block' => 'Block',
    'minimin_sale_price_override' => 'Minimum Sale Price Override',
    'product_sale_price_request' => 'Product Discounted Sale Price Request View',
    'details_with_combo_product' => 'with Combo Product (w/o ingredient)',
    'details_with_ingredient_product' => 'with Ingredient Product',
    'combo_product' => 'Combo Products',
    'import_discount' => 'Import Discount',
    'product_name' => 'Product Name',
    'peoduct_sku' => 'Product SKU',
    'discount_imported_successfully' => 'Discount Imported successfully',
    'upload_discount_data_in_excel_format' => 'Upload discount data in excel format',
    'choose_location_discount_and_group_by' => 'Choose business location and column by which discount will be grouped',
    'product_name_discount_required' => '<b>Product name is required!</b><br> Enter extract product name with the system.when product is variable product please enter the main product name.',
    'product_sku_discount_required' => '<b>Product SKU - Product SKU Is Required!</b><br>When product is Variable product please enter the product variation SKU.',
    'start_time_end_time_error' => 'Start time cant be greater than end time.',
    'product_n_sku_dosent_match_with_location' => 'Product & SKU doesnt match with system',
    'ref_no'=>'Ref No',
    'woocommerce'=>'Woocommerce',
    'shopify'=>'Shopify',
    'sale_return'=>'Sale Return',
    'direct_sale'=>'Direct Sale',
    'sell_list_category_filter'=>'Sale Category Filter',
    'margin'=>'Margin',
    'margin_top'=>'Top',
    'margin_bottom'=>'Bottom',
    'margin_left'=>'Left',
    'margin_right'=>'Right',
    'return_combo_main'=>'Enable return combo products',
    'all_Physical_Stock_update_table'=>'Details of Stock Count Reports',
    'product_physical_Stock_report_imported_successfully'=>'Product physical Stock report imported successfully',
    'multi_variation_option' => 'Multi Variation Option',
    'b2b_business_list' => 'B2B Connection',
    'status' => 'Status',
    'pos_lot_popup_modal' => 'Enable POPUP view for Lot Products',
    'nr_return_modal' => 'Non-Receipt Return',
    'qty_exchange' => 'Some values are exchange from this purchase',
    'succesfully_exchange' => 'Successfully exchange',
    'created_by' => 'Created By',
    'sale_agents' => 'Sales Agent',
    'contacts' => 'Contact',
    'disable_credit_sale' => 'Disable credit sale',
    'credit' => 'CREDIT',
    'enable_credit_sale' => 'Access to credit sale',
    'life_time_warranty' => 'Life time warranty',
    'life_time' => 'Life time ',
    'rejected' => 'Rejected',
    'reject_recived' => 'Rejected-Received',
    'final_status_not_editable' => 'Transfer statuses can’t reverse',
    'product_qty_mismatch' => ':product_name Available quantity :qty_available cant over transfer',
    'search_product_for_transfer' => 'Search products for stock transfer',
    'purchase_qty' => 'Purchase',
    'edit_suspended_sale' => 'Edit suspended sale',
    'view_suspended_sale' => 'View suspended sale',
    'delete_suspended_sale' => 'Delete suspended sale',
    'user_doesnt_have_permission_to_edit_suspended_sales' => 'User doesn’t have permission to edit suspended sales',
    'user_dont_have_permission_for_credit_sale' => 'User doesn’t have permission for credit sale',
    'type_of_contact' => 'Type of contact numbers',
    'non_duplicate_number' => 'Non-Duplicable',
    'duplicable' => 'Duplicable',
    'to_location_access_restricted' => 'You don’t have permission for to location',
    'cant_skip_intransit_when_pennding' => 'If transfer status is ’Pending’, you should change it to ’In transit’ before mark as ’Received’. ',
    'from_location_access_restricted' => 'You don’t have permission for from location',
    'all_sale' => 'All Sales',
    'enable_suspend_to_all_sale' => 'Separated Suspend Sales',
    'enable_suspend_to_all_sale_help' => 'If you enable this , Suspend sales will not considering to all sales value. Suspend sales values will calculating saparately. Suspend sales will not effected to Profit Lost Report.',
    'return_sale' => 'Return Sale',
    'suspended_cancel_sales' => 'Suspend Cancel',
    'accept_nr_exchange' => 'Access Non Receipt exchange ',
    'standard' => 'Standard',
    'round_up' => 'Round Up',
    'round_down' => 'Round Down',
    'current_stock_sub_units' => 'Current Stock(Sub Units)',
    'current_stock_main_unit' => 'Current stock(Main Unit)',
    'stock_report' => 'Stock Report',
    'stock_subunits' => 'Show stock subunits',
    ...
    'agents' => 'Agents',
    'agent_deleted_success' => 'Agent deleted success',
    'mobile_number_already_taken' => 'Mobile number already taken',
    'self_receiving_restricted' => 'Self-receiving restricted',
    'receiving_restricted' => 'Transfer Receiving restricted',
    'user' => 'User',
    'old_status' => 'Old Status',
    'new_status' => 'New Status',
    'event' => 'Event',
    'return_sale_return' => 'Refund of sale return',
    'close_register' => 'Close the Register Report',
    'daily_sale' => 'Daily Sale',
    'customer_notification' => 'Customer Notification',
    'leave_empty_to_autogenerate' => 'Leave empty to autogenerate',
    'enable_minus_1' => 'Enable minus product',
    'enable_minus_2' => 'quantity adding option on sale &nbsp;&nbsp;&nbsp;',
    'enable_minus_tooltip' => 'User can add minus quantity on sale and it will be record as sale return in same bill',
    ...
    'view_pos_notification_bell' => 'View POS notification bell',
    'view_kitchen_notification' => 'View kitchen notification for create user',
    'view_kitchen_notification_for_all' => 'View kitchen notification for all',
    'view_kitchen_notification_for_assign_user' => 'View kitchen notification for assign user',
    'view_kitchen_report' => 'View kitchen report',
    'lot_no_uniq_to_business' => 'Lot number is unique for the business',
    'tooltip_enable_lot_number_b_uniq' => 'If not Lot number is unique for the product',
    'lot_number_exist' => ':lot_number Lot number already exist. Please enter a new one',
    'woocomerce_disabled' => 'Woocommerce Disabled',
    'enable_mass_woocommerce_sync' => 'Enable Woocommerce sync For Selected Products',
    'disable_mass_woocommerce_sync' => 'Disable Woocommerce sync For Selected Products',
    'disable_woocommerce_sync' => 'Disable Woocommerce sync Success',
    'enable_woocommerce_sync' => 'Enable Woocommerce sync Success',
    'add_selling_price_groups' => 'Add Selling Price Groups',
    'selling_price_groups' => 'Add Selling <br> Price Groups ',
    'the_selling_price_group_not_considered' => 'The selling price group is not considered when there are lot numbers.',
    'com_agent' => 'Sales Commission Agent',
    'product_already_used_as_combo_products' => 'Product already used as combo products',
    'sale_report_against_branches_date' => 'Daily Sale Report',
    'sale_report_against_branches_date_for_blade' => 'Daily Sale Report',
    'remove_minus_quantity' => 'Disable Minus Quantity adding option from all sections.( Purchase order/ sales/ opening stock/ stock transfer/ stock adjustment)',
    'remove_minus_qty' => 'Please select more than 0 units',
    'import_error' => 'Your request has been reject',
    'add_as_sub_cat' => 'Add as sub-category',
    'last_updated_price_will_be_add_to_all_items' => 'Don’t consider lot price',
    'tooltip_for_last_updated_price_will_be_add_to_all_items' => 'If this enabled, last updated selling price will apply to current stock of the items.',
    'product_sell_report_for_location_vise' => 'Location Wise Product <br/>&nbsp;&nbsp;&nbsp;&nbsp; Sell Report',
    'product_sell_report_for_location_vise_for_blade' => 'Location Wise Product Sell Report',
    'product_table_column_order' => 'Products Table Column Order',
    'change_packing_label' => 'Change Packing Label',
    'dialog_key' => 'Dialog Key',
    'dialog_mask' => 'Dialog Mask',
    'sub_unit_exists' => 'Sub Units Exist',
    'disable_lot_wise_selling_price_manage_option1' => 'Disable Lot Wise Selling',
    'disable_lot_wise_selling_price_manage_option2' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#8202; Price Manage Option',
    'sub_cat_exists' => 'Sub Category Exist',
    'cat_cannot_be_deleted' => 'Products exist with this category; Cannot be deleted',
    'enable_current_stock_showing_option' => 'Enable current stock showing option',
    'qty_not_available' => 'There is insufficient quantity',
    'requested_selling_price_is' => 'Requested selling price is :status for (:product) on :ref_no',
    'tooltip_default_selling_price' => 'The DEFAULT SELLING PRICE means the last added/edited SALES PRICE',
    'send_request' => 'Send Request',
    'note' => 'Note',
    'suspend_note_msg' => 'This invoice will be suspended until admin is Approved/Rejected. You can view this invoice, from SUSPENDED SALES',
    'request_note' => 'Request Note',
    'show_invoice_reprint_count' => 'Show Invoice Reprint Count',
    'invoice_reprint_count_label' => 'Invoice Reprint Count Label',
    'no_of_pieces' => 'No of Pieces',
    'system_mismatch_product_fix' => 'Validation Error on the uploaded excel file',
    'exel_import_edit_adjustment' => 'Confirm Stock Adjustment',
    'physical_stock' => 'Physical Stock',
    'lot_no' => 'Lot No',
    'tooltip_not_consider_exel_import_current_stock' => 'These values are got from Excel sheet but not match with system stock. So these values are not considered to the calculation',
    'purchase_price_after_discount' => 'Purchase Price After Discount',
    'woocom_custom_statues' => '<b>WARNING:</b> If there are any custom statuses other than following Woocommerce statuses, <br> it will be considered as FINAL in POS sell statuses.',
    'report_generated' => ':report_name is Generated',
    'queued_report' => 'Last Updated Report List on Time',
    'queue_this_report' => 'Generate',
    'report_history' => 'Report History',
    'select_report_to_preview' => 'Select report to preview :',
    'enable_last_lot' => 'Enable Last Lot Show Option',
    'tooltip_enable_last_lot' => 'If this setting is enabled, the lot number of the invoice will be shown on the purchase screen.',
    ...
    'show_date' => 'show Date',
    'suspend_invoice_layout_for_pos' => 'Suspend Invoice layout for POS',
    'access_modifiers' => 'Access Modifiers',
    'custom_payment_4' => 'Custom Payment 4',
    'custom_payment_5' => 'Custom Payment 5',
    'enable_supplier_bill_no' => 'Enable Supplier Bill No. for Purchase Invoices',
    'synced_to_ogf' => 'Synced to One Galle Face',
    'tooltip_enable_supplier_bill_no' => 'When enabled, you will get a field for entering Supplier Bill No.',
    'auto_save_last_sales_agent' => 'Auto save last selected sales agent',
    'grouped_by_date' => 'Grouped By Date',
    'grouped_by_product' => 'Grouped By Product',
    'default_quantity_help' => '- <b>Default Quantity:</b>  When adding a product to the transfer, the quantity is automatically set to \'01\'. This serves as the default amount for the transfer.<br><br>
    - <b>Current Stock Quantity:</b> When adding a product to the transfer, the quantity is pre-filled with the current stock level of that product. This ensures that the transfer quantity matches the available stock.',
    'enable_lot_number_auto_generation' => 'Enable Lot Number Auto Generation',
    'tooltip_enable_lot_number_auto_generation' =>  'Enable Lot Number Auto Generation Mode.',
    'lot_settings' => 'Lot Settings',
    'lot_name' => 'Name',
    'lot_prefix' => 'Prefix',
    'lot_start_number' => 'Start From',
    'lot_count' => 'Lot Count',
    'lot_total_digits' => 'Number of Digits',
    'lot_number_generation' => 'Lot Number Generation',
    'add_lot_number_format' => 'Add Lot Number Format',
    'lot_set_as_active' => 'Set As Active',
    'edit_lot_number_format' => 'Edit Lot Number Format',
    'lot_auto_generate_option' => 'Lot Number will Auto Generate!',
    'purchases_settings' => 'Purchases Settings',
    'product_expire_date_exceeded' => 'Product expire date exceeded',
    'group' => 'Group',
    'total_return_shipping_charges' => 'Total Return Shipping Charges',
];
