...
class ModuleUtil extends Util
{
    ...
    public function availableModules()
    {
        return [
            ...
            'smpos_sale' => ['name' => __('sale.smpos_sale')],
            'is_smpos_sale_default' => ['name' => __('sale.is_smpos_sale_default'), 'tooltip' => __('sale.tooltip_is_smpos_sale_default')],

            'import_products_2' => ['name' => __('product.import_products_2')],

            'import_purchase' => ['name' => __('lang_v1.import_purchase')],
            'sales_commission_agents' => ['name' => __('lang_v1.sales_commission_agents')],
            'commission_type' => ['name' => __('lang_v1.commision_type')],
            'sale_types' => ['name' => __('lang_v1.sale_type'), 'tooltip' => __('lang_v1.tooltip_sale_types')],
            'multi_sale_types' => ['name' => __('lang_v1.multi_sale_types')],
