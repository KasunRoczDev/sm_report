...
class ReportController extends Controller
{
    ...
    public function sells_datatables()
    {
    ...
    public function getLotReport(Request $request): \Illuminate\Http\JsonResponse
    {
    ...
    public function getStockPosReport(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        $datatable = Datatables::of($products)
            ...
            ->editColumn('unit_price', function ($row) use ($allowed_selling_price_group) {
                ...
                if ($allowed_selling_price_group) {
                    $html .= ' <button type="button" class="btn btn-primary btn-xs btn-modal no-print" data-container=".view_modal" data-href="'.remote_action('ProductController@viewGroupPrice',
                            [$row->product_id]).'">'.__('lang_v1.view_group_prices').'</button>';
                }
