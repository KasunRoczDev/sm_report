...
class Media extends Model
{
    ...
    {
        $path = asset('/uploads_new/media/'.rawurlencode($this->file_name));
    ...
    {
        $path = public_path('uploads_new/media').'/'.rawurlencode($this->file_name);
    ...
    public static function deleteMedia($business_id, $media_id)
    {
        ...
        $media_path = public_path('uploads_new/media/'.$media->file_name);
