...
class BusinessLocation extends Model
{
    ...
    public static function forDropdownwithout($business_id, $location_in, $append_id = true, $check_permission = true)
    {
        $query = BusinessLocation::where('business_id', $business_id)->Active();
        ...
        if ($location_in) {
            $query->whereNotIn('id', [$location_in, $location_in]);
        }
    ...
    public static function forSelectOption($business_id)
    {
        $query = BusinessLocation::where('business_id', $business_id)->Active();
