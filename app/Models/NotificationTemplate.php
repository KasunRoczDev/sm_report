        ...
        $notification_template_data = [
            ...
            [
                ...
                'email_body' => '<p>Dear {contact_name},</p>
                    ...
                    <p>Your quotation is {invoice_number}<br />
                    ...
                    <p>&nbsp;</p>',
                'sms_body' => 'Dear {conntact_name}, Thank you for shopping with us. {business_name}',
                'subject' => 'Thank you from {business_name}',
                'auto_send' => '0',
            ],
            [
                'business_id' => $business_id,
                'template_for' => 'new_final',
                'email_body' => '<p>Dear {contact_name},</p>
